  ...
  return (
            ...
            <div className="pl-16 pr-16 py-24 items-center ">
                <div className="flex flex-col text-center w-full mb-15">
                    <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Games</h1>
                ...
                <div className="container mx-auto flex px-16 py-24 md:flex-row flex-col items-center">
                    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        ...
                        <p className="mb-8 leading-relaxed">Dive into enchanting worlds filled with puzzles, adventures, and endless fun for players of all ages.</p>
                ...
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    <p className="mb-8 leading-relaxed">Experience the power of blockchain in gaming through our web3-enabled titles, offering ownership and immersive gameplay.</p>
                    <div className="flex justify-center">
                    <button className="ml-4 inline-flex text-black py-2 px-6 border-2 border-gray-300 focus:outline-none hover:bg-gray-300 rounded text-lg">Lorem Ipsum</button>
                    </div>
                </div>
                ...
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    <p className="mb-8 leading-relaxed">Engage with our unique concepts that push boundaries and redefine gaming experiences.</p>
                    <div className="flex justify-center">
                    <button className="ml-4 inline-flex text-black py-2 px-6 border-2 border-gray-300 focus:outline-none hover:bg-gray-300 rounded text-lg">Lorem Ipsum</button>
                    </div>
                </div>
