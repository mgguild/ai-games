      ...
      <div className="flex items-center justify-center mb-28 relative z-10">
        <div className="container sm:px-0 px-8 py-24 mx-auto h-full">
          <div className="flex flex-wrap w-full mb-1 flex-col items-center text-center mt-48 sm:mt-20">
            ...
            <p className="sm:px-0 px-3 lg:w-5/6 w-full leading-loose lg:text-2xl sm:text-xl text-xl text-white font-medium mb-20">
            ...
            <p className="sm:px-0 px-3 lg:w-5/6 w-full leading-loose lg:text-2xl sm:text-xl text-xl text-white font-medium">
