  ...
  return (
        ...
        <div className=" pl-16 pr-16 py-24 items-center md:px-0">
            <div className="flex flex-col text-center w-full mb-15 pt-4 lg:pb-0 md:pb-32">
                <h1 className="title-font sm:text-4xl text-5xl mb-4 font-medium text-gray-900">Our Services</h1>
                <div className="border-t border-black w-1/4 mx-auto mb-4"></div>
                <h2 className="text-base text-black tracking-widest font-medium title-font mb-1 pb-8">
            ...
            <div className="container mx-auto flex lg:px-36 lg:py-24 md:flex-row flex-col md:py-1 md:px-1 items-center">
                ...
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    <h1 className="title-font sm:text-4xl text-4xl mb-2 pt-12 font-medium text-gray-900">Game Development
                    </h1>
                    <p className="mb-2 leading-relaxed text-lg">From conceptualization to launch, we breathe life into your ideas, leveraging cutting-edge technologies and creative prowess.</p>
