  ...
  return (
        ...
        <div className=" pl-16 pr-16 py-24 items-center">
            <div className="flex flex-col text-center w-full mb-15 pt-4">
                ...
                <h2 className="text-xs text-black tracking-widest font-medium title-font mb-1">At Astra Interactive Studios, we offer a spectrum of services tailored to elevate your gaming journey:</h2>
            </div>

            <div className="container mx-auto flex px-16 py-24 md:flex-row flex-col items-center">
            <div className="lg:w-full md:w-1/2 w-5/6">
            <Image src="/Game_Development.png" alt="logo" width={500} height={400} objectPosition='relative'/>
            </div>
            ...
            <div className="container mx-auto flex px-16 py-24 md:flex-row flex-col items-center">
                ...
                <Image src="/Web3_Integration.png" alt="logo" width={500} height={400} objectPosition='relative'/>
                </div>
            </div>

            <div className="container mx-auto flex px-16 py-24 md:flex-row flex-col items-center">
            <div className="lg:w-full md:w-1/2 w-5/6">
            <Image src="/Consultation.png" alt="logo" width={500} height={400} objectPosition='relative'/>
            </div>
            <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                <Image src="/Custom_Solutions.png" alt="logo"width={500} height={400} objectPosition='relative'/>
                </div>
            </div>
            </div>
        </section>
