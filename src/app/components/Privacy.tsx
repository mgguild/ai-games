    ...
    <section
      ...
      className="flex px-6 sm:px-12 py-24 mt-0 flex-col bg-black border-8 border-black ">
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <p className="mb-4">Your privacy is important to us. It is Astra Interactive Studios's policy to respect your privacy regarding any information we may collect from you across our website, https://astrainteractive.studio, and other sites we own and operate.</p>
